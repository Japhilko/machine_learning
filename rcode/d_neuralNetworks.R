...
#' 
## ----eval=F--------------------------------------------------------------
## ggpairs(Yacht_Data,title="Scatterplot Matrix - features of Yacht dataset")
...
#' 
#' ![](figure/ggpairs_yacht.png){height=80%}
#' 
...
#' 
#' ![](figure/class01-1.png){height=70%}
#' 
#' 
