...
- Recall, the test data set contains observations not used to train the Yacht_NN1 ANN. 
- To calculate the test error, we first must run our test observations through the Yacht_NN1 ANN. 
