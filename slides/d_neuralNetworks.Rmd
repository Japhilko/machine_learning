...
- They are [**function approximators**](https://deepmind.com/research/publications/universal-value-function-approximators/), mapping inputs to outputs, 
...
- Much of the following slides is based on UC Business Analytics R Programming Guide - [**neural networks**](http://uc-r.github.io/ann_fundamentals)
...
![](figure/neuralnetfig.PNG){height=120%}
...
- The capability of ANNs to learn approximately any function, (given sufficient training data examples) are dependent on the appropriate selection of the [**activation function(s)**](https://en.wikipedia.org/wiki/Activation_function) present in the network. 
