...
```{r,fig.height=3}
plot(density(ames_data$Sale_Price))
```
...
- A ridge model is good if you believe there is a need to retain all features in your model yet reduce the noise that less influential variables may create and minimize multicollinearity. 
