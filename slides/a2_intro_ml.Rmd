...
- It's often used as an advanced form of predictive modeling.
 ...
 -   This is necessary to build a predictive model 
 - You must tell the algorithm what's "correct" while training it (hence, "supervising" it).
...
<!--
Most common tasks are clustering, representation learning, and density estimation -
-->
