...
### 1) Load the the built-in dataset `swiss` 
<!--
and answer the following questions:
-->
- a - How many observations and variables are available?
- b - What is the scale level of the variables?

### 2) Create an interactive data table
