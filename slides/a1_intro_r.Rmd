...
```{r}
path1 <- "http://archive.ics.uci.edu/ml/machine-learning-databases/00243/"
dname <- 'yacht_hydrodynamics.data'
```


```{r}
url<- paste0(path1,dname)
...
library(magrittr)
# Drop variables
clean_titanic <- titanic %>% 	mutate(pclass = factor(pclass, levels = c(1, 2, 3), labels = c('Upper', 'Middle', 'Lower')),
