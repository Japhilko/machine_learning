...
- Our OOB RMSE ranges between `r roob_hg[1]`-`r roob_hg[2]`. 
- Our top 10 performing models all have RMSE values right around `r roundmeantop10` and the results show that models with slighly larger sample sizes (70-80 per cent) and deeper trees (3-5 observations in an terminal node) perform best. 
