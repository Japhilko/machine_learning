...
```{r,eval=F,echo=F}
save(OOB_RMSE,optimal_ranger,file="../data/ml_rf_OOB_RMSE.RData")
```
...
- We see that `r sort(varimp_ranger)[1]` has the greatest impact in reducing MSE across our trees, followed by `sort(varimp_ranger)[2]`, `sort(varimp_ranger)[3]`, etc.
