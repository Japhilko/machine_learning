...
The `gbm` R package is an implementation of extensions to Freund and Schapire’s [**AdaBoost**](https://en.wikipedia.org/wiki/AdaBoost) algorithm and [**Friedman’s gradient boosting machine**](https://www.frontiersin.org/articles/10.3389/fnbot.2013.00021/full). This is the original R implementation of GBM. 
...
- `cv.folds` will be presented which perform a 5 fold cross validation. 
...
- The training error continues to decrease to 965 trees where the RMSE nearly reaches zero; 
