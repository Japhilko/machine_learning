...
```{r, echo=TRUE}
calc.sentiment("My name is Emily", glove.df=glove.df)

calc.sentiment("My name is Heather", glove.df=glove.df)

calc.sentiment("My name is Yvette", glove.df=glove.df)

calc.sentiment("My name is Shaniqua", glove.df=glove.df)
